...
export default function LegendStory() {
  const chapters = [
    {
      num: '01',
      title: 'Solana Street Runner (2021)',
      text: 'Back in 2021, while Robinhood was still dreaming about becoming the king of finance, a legend was already running wild on Solana. A street dog with one mission: fetch the cash.',
    ...
    {
      num: '02',
      title: 'The Bear Market Savior',
      text: 'He was there through every bull run. When degens were crying in the bear market, Cash Dog showed up with the bags. Loyal. Relentless. Always sniffing out the next 100x.',
      icon: <Trophy className="w-6 h-6 text-amber-500" />,
      accent: 'border-amber-500/20 hover:border-amber-400/80',
      badge: 'LOYALTY FIRST',
    },
    {
      num: '03',
      title: 'Back with a Vengeance',
      text: 'Now he’s back with a vengeance. While Cash Cat is busy taking selfies in the Robinhood wallet, Cash Dog is out here on Solana hunting real money and delivering it straight to the pack.',
    ...
    {
      num: '04',
      title: 'Cats Scratch, Dogs Fetch',
      text: 'Cats scratch. Dogs fetch. Welcome to the era of Cash Dog. No utility. Just loyalty and gains.',
    ...
    <section id="story" className="relative py-24 px-4 bg-gradient-to-b from-bg-dark to-black z-20 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            ...
            <h2 className="mt-4 text-4xl sm:text-5xl md:text-6xl font-display font-extrabold text-white tracking-tight uppercase">
              The Legend of <span className="text-gradient bg-gradient-to-r from-primary to-amber-500 bg-clip-text text-transparent text-glow-gold">$CASHDOG</span>
            </h2>
            <p className="mt-4 max-w-2xl mx-auto text-gray-400 font-sans text-sm sm:text-base">
              The epic story of Solana's supreme wealth fetcher. While other memes sit pretty on wallpapers, $CASHDOG runs the streets fetching real bags.
            </p>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-16 p-8 rounded-3xl bg-gradient-to-r from-amber-500/10 via-primary/5 to-yellow-500/10 border-2 border-primary/20 text-center relative overflow-hidden"
        >
          ...
          <p className="text-xl sm:text-2xl md:text-3xl font-display font-bold italic text-white leading-snug">
            "While Cash Cat is busy taking selfies... Cash Dog is out here on Solana hunting real money and delivering it straight to the pack."
          </p>
